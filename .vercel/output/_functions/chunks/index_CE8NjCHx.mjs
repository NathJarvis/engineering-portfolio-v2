...
import { $ as AstroError, Y as UnknownContentCollectionError } from "./errors-data_BOFQy4b8.mjs";
import { c as isRemotePath, d as removeBase } from "./path_DW70cvEd.mjs";
import { I as generateCspDigest, b as unescapeHTML, d as maybeRenderHead, i as renderComponent, p as addAttribute, t as spreadAttributes, u as renderTemplate } from "./server_DTTxIANh.mjs";
...
var ImmutableDataStore = class ImmutableDataStore {
	...
	*/
	static async fromModule() {
		try {
			const data = await import("./_astro_data-layer-content_Bz6fgrB4.mjs");
...
var $$Index = createComponent(async ($$result, $$props, $$slots) => {
	const sortedPosts = (await getCollection("blog")).sort((a, b) => new Date(b.data.publishDate).valueOf() - new Date(a.data.publishDate).valueOf());
	return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {
		"title": "Station 02 // Technical Case Studies & Field Logs - Nathan Jarvis, ACABE",
		"description": "Technical Case Studies & Engineering Logs - Practical investigations into MEP asset condition, electrical distribution losses, and statutory compliance by Nathan Jarvis, ACABE.",
		"data-astro-cid-x255k2k2": true
	}, { "default": ($$result) => renderTemplate`${maybeRenderHead($$result)}<main class="responsive-shell" data-astro-cid-x255k2k2><a href="/" class="back-btn" aria-label="Return to Homepage" data-astro-cid-x255k2k2>← RETURN TO PORTFOLIO HOME</a><div class="station-grid" data-astro-cid-x255k2k2><!-- Sidebar Summary --><aside class="hud-sidebar" aria-label="Technical Logs Overview" data-astro-cid-x255k2k2><div class="sidebar-header" data-astro-cid-x255k2k2>REPOSITORY OVERVIEW</div><div class="meta-row" data-astro-cid-x255k2k2><div class="meta-label" data-astro-cid-x255k2k2>DISCIPLINE</div><div class="meta-val" data-astro-cid-x255k2k2>Building Services & M&E Engineering</div></div><div class="meta-row" data-astro-cid-x255k2k2><div class="meta-label" data-astro-cid-x255k2k2>PRIMARY SCOPE</div><div class="meta-val" style="color: var(--neon-cyan);" data-astro-cid-x255k2k2>Plant Degradation & Distribution Losses</div></div><div class="meta-row" data-astro-cid-x255k2k2><div class="meta-label" data-astro-cid-x255k2k2>ARTICLES COMPILED</div><div class="meta-val" data-astro-cid-x255k2k2>${sortedPosts.length} Case Studies</div></div><div class="meta-row" data-astro-cid-x255k2k2><div class="meta-label" data-astro-cid-x255k2k2>BENCHMARK STANDARDS</div><div class="meta-val" data-astro-cid-x255k2k2>CIBSE Guide M • BS 7671 • SFG20</div></div><div class="meta-row" data-astro-cid-x255k2k2><div class="meta-label" data-astro-cid-x255k2k2>STATUS</div><div class="meta-val" data-astro-cid-x255k2k2><span class="status-pill" data-astro-cid-x255k2k2>PUBLISHED CASE STUDIES</span></div></div></aside><!-- Main Content Stream --><section class="main-stream" data-astro-cid-x255k2k2><div class="page-tag" data-astro-cid-x255k2k2>STATION // 02</div><h1 class="page-title" data-astro-cid-x255k2k2>Technical Case Studies & Field Logs</h1><p class="page-lead" data-astro-cid-x255k2k2>Field investigations, distribution power loss assessments, statutory compliance transitions (UK RoHS / Part L), and HVAC plant degradation analyses grounded in empirical building services engineering.</p><div class="articles-stack" data-astro-cid-x255k2k2>${sortedPosts.map((post) => renderTemplate`<a${addAttribute(`/blog/${post.id}`, "href")} class="article-card"${addAttribute(`Read engineering case study: ${post.data.title}`, "aria-label")} data-astro-cid-x255k2k2><div data-astro-cid-x255k2k2><div class="article-meta-line" data-astro-cid-x255k2k2><span class="article-category" data-astro-cid-x255k2k2>${post.data.category || post.data.tag || "M&E AUDIT"}</span><time${addAttribute(new Date(post.data.publishDate).toISOString(), "datetime")} data-astro-cid-x255k2k2>${new Date(post.data.publishDate).toLocaleDateString("en-GB", {
		year: "numeric",
		month: "short",
		day: "numeric"
	})}</time></div><h2 class="article-heading" data-astro-cid-x255k2k2>${post.data.title}</h2><p class="article-desc" data-astro-cid-x255k2k2>${post.data.description}</p></div><div class="article-footer-cta" data-astro-cid-x255k2k2><span data-astro-cid-x255k2k2>FIELD CASE STUDY</span><span data-astro-cid-x255k2k2>READ TECHNICAL AUDIT →</span></div></a>`)}</div></section></div></main>${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-x255k2k2": true })}` })}`;
}, "C:/Users/natha/Documents/engineering-portfolio-v2/src/pages/blog/index.astro", void 0);
var $$file = "C:/Users/natha/Documents/engineering-portfolio-v2/src/pages/blog/index.astro";
var $$url = "/blog";
//#endregion
